...
export class CustomerServiceProxy {
     ...
     * @return Success
     */
    createOrUpdateCustomer(input: CustomerDto | null | undefined): Observable<void> {
     ...
     * @return Success
     */
    getCustomerForEdit(id: number | null | undefined): Observable<CustomerDto> {
    ...
    protected processGetCustomerForEdit(response: HttpResponseBase): Observable<CustomerDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getCustomers(): Observable<ListResultDtoOfCustomerListDto> {
    ...
    protected processGetCustomers(response: HttpResponseBase): Observable<ListResultDtoOfCustomerListDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListResultDtoOfCustomerListDto.fromJS(resultData200) : new ListResultDtoOfCustomerListDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
